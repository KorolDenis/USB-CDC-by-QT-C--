...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->setMaximumSize(QSize(863, 618));
        ...
        tableWidget->setGeometry(QRect(10, 20, 671, 361));
        layoutWidget = new QWidget(centralwidget);
        layoutWidget->setObjectName(QString::fromUtf8("layoutWidget"));
        layoutWidget->setGeometry(QRect(690, 20, 141, 361));
